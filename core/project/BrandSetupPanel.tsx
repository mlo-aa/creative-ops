...
export function BrandSetupPanel() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-8">
      <h2 className="text-2xl tracking-[-0.03em]">Brand setup</h2>
      ...
      <h3 className="mt-12 text-xs tracking-[0.16em] uppercase opacity-50">Typography</h3>
      ...
      <h3 className="mt-12 text-xs tracking-[0.16em] uppercase opacity-50">Logos</h3>
